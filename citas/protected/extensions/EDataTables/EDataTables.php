...
class EDataTables extends CGridView
{
	...
	public function registerClientScript()
	{
		...
		$defaultOptions = array(
			...
			'pagerClass'		=> $this->bootstrap ? 'paging_bootstrap pagination '.$this->pagerCssClass : $this->pagerCssClass,
...
// 		$baseScriptUrl = Yii::app()->getBaseUrl().'/protected/extensions/EDataTables/assets';

...
<div id="userAssignments" class="box grid_12">

	<div class="box-head"><h2><?php echo Rights::t('core', 'Assignments for :username', array(
		':username'=>$model->getName()
	)); ?></h2></div>
	
	<div class="assignments span-12 first box-content no-pad">
	...
	<div class="box-head"><h2><?php echo Rights::t('core', 'Assign item'); ?></h2></div>
	<div class="add-assignment span-11 last box-content">

...
<div id="updatedAuthItem" class="box grid_12">

	<div class="box-head"><h2><?php echo Rights::t('core', 'Update :name', array(
		':name'=>$model->name,
	...
	<div class="box-head"><h2><?php echo Rights::t('core', 'Relations'); ?></h2></div>
	<div class="relations span-11 last box-content no-pad">
